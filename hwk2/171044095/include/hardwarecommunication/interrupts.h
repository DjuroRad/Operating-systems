    ...
    namespace hardwarecommunication
    {
        ...
        class InterruptManager
        {
            ...
            public:
                ...
                InterruptManager(myos::common::uint16_t hardwareInterruptOffset, myos::GlobalDescriptorTable* globalDescriptorTable, myos::TaskManager* taskManager, int* clock_count, TableEntry* pageTable);
                ~InterruptManager();
                myos::common::uint16_t HardwareInterruptOffset();
                void Activate();
                void Deactivate();
